...
for (let j = 0; j < 4; j++) {
    for (let i = 0; i < 4; i++)
        new Car(roadE.tracks[j % 2].lanes[j - (j % 2)], 10 * i, 0);
    for (let i = 0; i < 2; i++)
        new Car(roadN.tracks[j % 2].lanes[j - (j % 2)], 10 * i, 0);
    for (let i = 0; i < 4; i++)
        new Car(roadW.tracks[j % 2].lanes[j - (j % 2)], 10 * i, 0);
    for (let i = 0; i < 2; i++)
        new Car(roadS.tracks[j % 2].lanes[j - (j % 2)], 10 * i, 0);
}
